...
echo "════════════════════════════════════════════════════════════"
run_cmd "python3 -m experiments.run_experiment --problem tsp      --cities ${CITIES} --runs ${RUNS} --seed ${SEED} --outdir ${OUTDIR} ${SCALE_ISLANDS}"
run_cmd "python3 -m experiments.run_experiment --problem rastrigin --dims ${DIMS}   --runs ${RUNS} --seed ${SEED} --outdir ${OUTDIR} ${SCALE_ISLANDS}"
